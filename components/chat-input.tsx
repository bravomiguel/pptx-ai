...
export function ChatInput({
  ...
  return (
    <form ref={formRef} onSubmit={onSubmit} className="flex w-full pb-6 px-4 pt-3">
      <div className="max-w-3xl mx-auto w-full relative border-1 rounded-lg ring-offset-background transition-all focus-within:ring-2 focus-within:ring-gray-600">
